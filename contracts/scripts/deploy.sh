#!/usr/bin/env bash
#
# Deploy the CharityCampaign contract to Stellar Testnet (or Mainnet).
#
# Prereqs:
...
WASM="target/wasm32-unknown-unknown/release/charity_campaign.optimized.wasm"
...
stellar contract optimize --wasm target/wasm32-unknown-unknown/release/charity_campaign.wasm
...
echo "   CHARITY_CONTRACT_ID=$CONTRACT_ID"
echo "   NEXT_PUBLIC_CHARITY_CONTRACT_ID=$CONTRACT_ID"
