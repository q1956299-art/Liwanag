...
- [x] **PPT/Pitch deck link** — [View Pitch Deck](https://docs.google.com/presentation/d/18ztZEUQWFvh0yFEKbla0y6oSxqFmeuEk/edit?usp=sharing)
- [x] **Demo video link** — [Watch Demo](https://drive.google.com/file/d/1oxZBPSlhnMZHrXBHbslObtai_0AeMcBS/view?usp=sharing)
...
- [x] **Google Sheet response export** — [open native Google Sheet](https://docs.google.com/spreadsheets/d/1i1jcL08JxIVkeEfxPRAk4oljfe-KqTqk7sfIHsWVh1w/edit?usp=drivesdk)

### Feedback survey

Have you tried Liwanag? [**Share your feedback**](https://docs.google.com/forms/d/e/1FAIpQLSfFGTrfeyF5a8wWEygerzeWREGm3lY1f97D-OpfWiO0n1DZMQ/viewform) — a 2-minute public survey. Responses are collected in the feedback sheet linked above.
...
| Google Sheet response export | https://docs.google.com/spreadsheets/d/1i1jcL08JxIVkeEfxPRAk4oljfe-KqTqk7sfIHsWVh1w/edit?usp=drivesdk |
...
| [`docs/user-feedback-log.md`](docs/user-feedback-log.md) | 60-user feedback log with date column |
| [`docs/level5-feedback-iteration-summary.md`](docs/level5-feedback-iteration-summary.md) | Feedback-to-iteration map |
| Google Sheet response export | https://docs.google.com/spreadsheets/d/1zk5d6k0nJ0UFrfLaCmMqtwc4uDnpyTVzM37U4xBGNXc/edit?usp=drivesdk |
...
| Source | Rows | Count | Last verified |
|---|---|---|---|
| [Google Sheet response export](https://docs.google.com/spreadsheets/d/1zk5d6k0nJ0UFrfLaCmMqtwc4uDnpyTVzM37U4xBGNXc/edit?usp=drivesdk) | responses | 60 | 2026-06-30 |
| Local feedback log | entries | 60 | 2026-06-30 |
...
```
https://docs.google.com/spreadsheets/d/1i1jcL08JxIVkeEfxPRAk4oljfe-KqTqk7sfIHsWVh1w/edit?usp=drivesdk    # native Google Sheet response export
```
